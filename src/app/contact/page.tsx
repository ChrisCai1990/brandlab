          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                {platforms.map((p) => (
                  <div key={p.name} className="flex items-center justify-between border border-[#b2d8d5] rounded-xl px-5 py-4 hover:border-[#5eada7] transition-colors">
                    <div>
                      <div className="text-sm font-medium text-[#0d2e2c]">{p.name}</div>
                      <div className="text-xs text-[#5a7e7c] mt-0.5">{p.desc}</div>
                    </div>
                    <div className="text-xs text-[#5eada7] font-medium">{p.handle}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
                {cooperationTypes.map((c) => (
                  <div key={c.title} className="border border-[#b2d8d5] rounded-xl p-4">
                    <div className="text-xl mb-2">{c.icon}</div>
                    <h3 className="text-xs font-bold text-[#0d2e2c] mb-1">{c.title}</h3>
                    <p className="text-[10px] text-[#5a7e7c] leading-relaxed">{c.desc}</p>
                  </div>
                ))}
              </div>
            </div>
