...
export async function generateStaticParams() {
  ...
  const all = Array.from(new Set([...mdxSlugs, ...tsSlugs]));
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="border-b border-[#C8DDD2] bg-[#F7FBF8]">
        <div className="max-w-7xl mx-auto px-8 py-3 flex items-center gap-2 text-xs text-[#6B7A6E]">
          ...
          <span>/</span>
          <span className="text-[#1A2E22] font-medium line-clamp-1">{article.title}</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <article className="lg:col-span-2">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-xs text-[#6B7A6E]">{article.date}</span>
              <span className="text-xs text-[#6B7A6E]">{article.readTime} 分钟阅读</span>
            </div>

            {/* Title */}
            <h1 className="text-3xl font-bold text-[#1A2E22] leading-tight mb-4">
              {article.title}
            </h1>
            ...
            <div className="mt-10 border border-[#2D6A4F] rounded-xl p-6 bg-[#E8F5EE]">
              ...
              <p className="text-sm text-[#1A2E22] leading-relaxed">{article.sections.action}</p>
            </div>
