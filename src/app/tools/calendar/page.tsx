...
const CONTENT_TYPES = [
  { label: "个人定位", bg: "bg-[#f0faf4]", text: "text-[#40916c]" },
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-8 py-12">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-[#1b4332] mb-3">30天内容排期生成器</h1>
          <p className="text-sm text-[#6b7280]">输入你的账号方向和发布频率，自动生成一份30天内容计划</p>
        </div>

        {/* Input */}
        <div className="bg-[#f0faf4] border border-[#95d5b2] rounded-2xl p-8 mb-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              />
              <p className="text-[10px] text-[#6b7280] mt-2">越具体越好，生成的选题更精准</p>
            </div>
            <div>
              <label className="block text-xs font-medium text-[#52b788] tracking-widest uppercase mb-3">
                每周发布频率
                ...
                {FREQ_OPTIONS.map((opt) => (
                  <button
                    ...
                    className={`border rounded-lg py-3 px-2 text-center transition-all ${
                      frequency === opt.value
                        ? "border-[#40916c] bg-[#f0faf4] text-[#40916c]"
        ...
        {generated && (
          <>
            ...
            <div className="grid grid-cols-7 gap-2 mb-2">
              {WEEK_LABELS.map((l) => (
                <div key={l} className="text-center text-[10px] text-[#6b7280] font-medium">
                  周{l}
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-7 gap-2">
              {schedule.map((item) => (
                ...
                >
                  <div className={`text-xs font-bold mb-2 ${item.active ? "text-[#1b4332]" : "text-[#95d5b2]"}`}>
                    {item.day}
                  </div>
        ...
        <div className="mt-16 border-t border-[#95d5b2] pt-14">
          <div className="mb-6">
            ...
            <h2 className="text-xl font-bold text-[#1b4332] mb-2">用 AI 生成更个性化的排期</h2>
          ...
          <div className="border border-[#95d5b2] rounded-2xl overflow-hidden">
            ...
            <div className="bg-white px-6 py-5">
              <pre className="text-[11px] text-[#4b5563] leading-relaxed whitespace-pre-wrap font-mono">
                {AI_PROMPT_TEMPLATE}
              </pre>
            </div>
          </div>
          ...
          <div className="mt-5 grid grid-cols-1 md:grid-cols-3 gap-3">
            {[
              ...
              <div key={item.step} className="flex gap-3 items-start bg-[#f0faf4] border border-[#E0EBE5] rounded-xl p-4">
                <span className="text-xs font-bold text-[#52b788] shrink-0 mt-0.5">{item.step}</span>
                <div>
